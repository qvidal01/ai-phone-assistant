...
def main():
    ...
    note = crm.create_note(customer["id"], "Customer called to confirm appointment. Very friendly.")
    ...
    updated_appt = crm.update_appointment(
        appointment["id"], {"notes": "Oil change, tire rotation, and brake inspection"}
    )
    ...
    updated_customer = crm.update_customer(customer["id"], {"email": "alice.johnson@newdomain.com"})
